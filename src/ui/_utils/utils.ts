...
export function getOriginalBodyPadding() {
  ...
  return parseInt((style && style.getPropertyValue('padding-right')) || 0 as any, 10)
}
...
export function DOMElement(props: { [x: string]: any; }, propName: string, componentName: string) {
...
export function addMultipleEventListeners(_els: any, handler: any, _events: any, useCapture: any) {
  let els = _els
  if (!isArrayOrNodeList(els)) {
    els = [els]
  }
  ...
  Array.prototype.forEach.call(events, (event: any) => {
